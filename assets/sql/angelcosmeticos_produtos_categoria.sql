...
CREATE TABLE `produtos_categoria` (
  ...
  CONSTRAINT `produtos_categoria_ibfk_1` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`),
  CONSTRAINT `produtos_categoria_ibfk_2` FOREIGN KEY (`categoria_id`) REFERENCES `categorias_produtos` (`id`)
...
-- Dump completed on 2024-12-06  3:43:35
