...
CREATE TABLE `historico_compras` (
  ...
  CONSTRAINT `historico_compras_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `historico_compras_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`)
